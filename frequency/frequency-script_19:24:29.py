...
with open("./combo.csv", "a") as f:
    ...
    wav_file_name = '2020-05-14-19:24:29.wav'
    ...
    while i <= 600:
        ...
        if i >= 0:
            ...
            # not decisive
            if not 150 <= i <= 210 or 220 <= i <= 240 or 290 <= i <= 300 or 320 <= i <= 330 or 340 <= i <= 380 or 410 <= i <= 420 or 440 <= i <= 470 or 480 <= i <= 500 or 540 <= i <= 550 or 560 <= i <= 570:
                # for sure bee vs for sure no bee
                if 210 < i < 220 or 300 < i < 320 or 330 < i < 340 or 420 < i < 440 or 470 < i < 480 or 550 < i < 560:
