...
with open("./combo.csv", "a") as f:
    ...
    while i <= 600:
        ...
        if i >= 0:
            ...
            # not decisive
            if not 10 <= i <= 20 or 50 <= i <= 80 or 90 <= i <= 130 or 160 <= i <= 170 or 190 <= i <= 200 or 220 <= i <= 260 or 270 <= i <= 420 or 440 <= i <= 480:
                # for sure bee vs for sure no bee
                if 20 < i < 50 or 200 < i < 220 or 260 < i < 270:
                    peak_list[index] = 'black-bee'
                else:
